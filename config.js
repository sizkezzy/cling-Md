...
module.exports = {
  ...
  menu: process.env.MENU || "", /**  Available @MENU @Schemes 1: Aztec_Md, 2: A17_Md, 3: Cling-Md Default ---------- If Not Choose then it Randomely Pic One Of Them Each time **/

  HANDLERS: process.env.PREFIX  || ".",
  BRANCH  : process.env.BRANCH  || "main",
  VERSION : process.env.VERSION || "1.3.0",
  caption : process.env.CAPTION || "©Whiz-ᴍᴅ" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ Whiz 』```", //*『sᴜʙsᴄʀɪʙᴇ • whiz』*\nhere
 
  author : process.env.PACK_AUTHER|| "Cling-MD",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "cling-ᴍᴅ",
